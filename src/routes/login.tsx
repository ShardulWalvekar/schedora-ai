  ...
  async function handleGoogle() {
    try {
      ...
      if (msg.toLowerCase().includes("unsupported provider") || msg.toLowerCase().includes("not enabled")) {
        toast.error("Google sign-in is not configured yet. Please enable the Google provider in your Supabase Dashboard under Authentication → Providers.");
      } else {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="glass-card rounded-2xl p-8 border border-border animate-fade-in">
          ...
          <p className="text-sm text-muted-foreground text-center mb-8">Sign in to your account to continue</p>
